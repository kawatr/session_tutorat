...
public class AdminDashboardController {
    ...
    public String deleteUse(@PathVariable Long userId) {
    ...
    public String showUpdateUserForm(@PathVariable Long userId, Model model) {
        User existingUser = adminDashboardService.getUserById(userId);
        ...
        // Add the existing user to the model
        model.addAttribute("existingUser", existingUser);

        // Return the update user form view
        return "update_user_form";
    }

    @PostMapping("/admin/users/update/{userId}")
    public String updateUser(@PathVariable Long userId,
                             @ModelAttribute("existingUser") @Valid User updatedUser,
                             BindingResult result, Model model) {
        if (result.hasErrors()) {
            // Handle validation errors
            return "update_user_form";
        ...
        adminDashboardService.updateUser(existingUser);
